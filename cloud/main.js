...
Parse.Cloud.define("allCount", async (request) => {
    return await dbUtils.runFunction("getCountOfAllCollection()", [])
})

Parse.Cloud.define("allSchemaStat", async (request) => {
    return await dbUtils.runFunction("getCollectionsStat()", [])
})
